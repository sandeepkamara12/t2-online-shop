        ...
        <header className="header">
            <div className="header-top">
                <div className="container">
                    ...
                    <button type="button" className="btn btn-primary" data-toggle="modal" data-target="#countryList">{context.selectedCountry?context.selectedCountry:'Select Country'}</button>
                    <CountryDropdown /> 
            ...
            <div className="container">
                <div className="header-left">
                    ...
                    <Link to="index.html" className="logo">
                        <img src="/images/logo.png" alt="Panda Logo" width="105" height="25" />
                    </Link>
                ...
                userCartProducts?.length > 0 && */}
                    ...
                    <div className="dropdown-cart-action">
                        ...
                        <Link to="checkout.html" className="btn btn-outline-primary-2">
                        <span>Checkout</span>
                        <i className="icon-long-arrow-right"></i>
                        </Link>
                    </div>
